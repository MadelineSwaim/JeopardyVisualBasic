Public Class frmOldAnime
    Dim arrCat1Ans = New String() {"They are a Pembroke Welsh Corgi.", "Spike's fighter craft.", "This character uses the same pistol seen firing in the opening title sequence.", "Miles' favourite team.", "This is the real name of Punch from Big Shots."}
    Dim arrCat2Ans = New String() {"The name of the giant organic robots in Neon Genesis Evangelion.", "These are the opposing creatures in Neon Genesis Evangelion.", "Lilith wears a mask with this many eyes on it.", "The name of the 9th Angel, Matarael means this.", "'Nerv', 'Gehirn', and this element are the three elements that synchronize with the Evangelions."}
    Dim arrCat3Ans = New String() {"Goku's Saiyan name.", "The only person Goku fears.", "Creator of the Dragon Balls.", "'Piccolo' means this in Namekian.", "Goku's power level when Raditz first read it."}
    Dim arrCat4Ans = New String() {"This is the reason that Ash doesn’t normally keep Pikachu in his pokeball.", "These were the Pokemon involved in the battle that won Ash the Volcano Badge.", "This is the name of one of the Eevee brothers and their eeveelution (pick any one).", "This is the Legendary pokemon that Ash sees in the first episode.", "Jessie and James call this town their 'hometown'."}
    Dim arrCat5Ans = New String() {"This person raised Vash and his brother.", "Name of Vash's twin brother.", "Milly's nickname.", "This is Vash’s Age.", "The insurance company Meryl and Millie represent."}
    Dim arrCat6Ans = New String() {"This is the main characters name (English or Japanese).", "This cross dressing bad guy was a member of the Dark Circus.", "Sailor Mars uses these ancient Japanese superstition symbols to activate her powers.", "'Please, Pegasus! Protect everyone's dreams! Twinkle Yell' is this Sailor Scout’s battle cry in the battle against the Dark Moon Circus.", "This villain is the flip, or mirror, side to the good original queen of the moon."}

    Dim arrCat1Ques = New String() {"What/Who is Ein?", "What is Swordfish? ", "Who is Spike?", "What is Bluesox? ", "Who is Alfredo?"}
    Dim arrCat2Ques = New String() {"What is Evas?", "What are angels? ", "What is Seven?", "Who is Angel of Rain?", "What is 'Seele'? "}
    Dim arrCat3Ques = New String() {"Who is Kakarot? ", "Who is Chi-Chi?", "Who is Kami?", "What is 'Other World'?", "What is 330?"}
    Dim arrCat4Ques = New String() {"What is Pikachu doesn’t like being in his pokeball? ", "Who are Charizard and Magmar?", "Who are Mikey and Eevee; Sparky and Jolteon; Pyro and Flareon; or Rainer and Vaporeon?", "What is Ho-Oh?", "What is Sunny Town?"}
    Dim arrCat5Ques = New String() {"Who is Rem?", "Who is Knives?", "What is ‘Stun Gun Milly’?", "What is 130?", "What is the Bernadelli Insurance Society?"}
    Dim arrCat6Ques = New String() {"Who is Serena/Usagi?", "Who is Fisheye?", "What are Charms/Wards/Scriptures?", "Who is Sailor Chibi/Mini Moon?", "Who is Queen Nehellenia?"}

    Dim intCounter As Integer = 0
    Dim intDaDoCat As Integer = 0
    Dim intDaDoPt As Integer = 0

    Private Sub frmOldAnime_Load(sender As Object, e As EventArgs) Handles MyBase.Load
